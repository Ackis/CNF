...
frFR localization strings for Chuck Norris Facts
...
Please update http://www.wowace.com/projects/cnf/localization/frFR/ for any translation
...
local L = LibStub("AceLocale-3.0"):NewLocale("Chuck Norris Facts", "frFR")
